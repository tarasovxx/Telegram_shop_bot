...
from db import sql_start, add_value, add_user, add_order, print_products, get_info, checker, receive_method, add_suggestion, pay_method_db, add_check, get_check, delete_check, get_floor, add_campus, get_campus
...
async def text(message: types.Message):
    global offset, limit, showed, message_def, choices, remove_check, rent_price, final_price
